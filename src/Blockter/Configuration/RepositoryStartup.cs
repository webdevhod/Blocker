...
using Blockter.Domain.Repositories.Interfaces;
using Blockter.Infrastructure.Data.Repositories;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("Blockter.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("Blockter.Infrastructure.Data.Repositories") &&
