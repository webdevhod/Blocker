...
using Blockter.Domain.Services;
...
using AuthenticationService = Blockter.Domain.Services.AuthenticationService;
using IAuthenticationService = Blockter.Domain.Services.Interfaces.IAuthenticationService;
